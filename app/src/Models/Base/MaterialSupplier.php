...
/**
 * Base class that represents a row from the 'moc.material_supplier' table.
 *
 *
 *
* @package    propel.generator.MocApi.Models.Base
*/
abstract class MaterialSupplier implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\MocApi\\Models\\Map\\MaterialSupplierTableMap';
    ...
    /**
     * Initializes internal state of MocApi\Models\Base\MaterialSupplier object.
     */
    ...
    /**
     * Compares this with another <code>MaterialSupplier</code> instance.  If
     * <code>obj</code> is an instance of <code>MaterialSupplier</code>, delegates to
     * <code>equals(MaterialSupplier)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MaterialSupplier The current object, for fluid interface
     */
     ...
     * @return $this|\MocApi\Models\MaterialSupplier The current object (for fluent API support)
     */
    public function setMaterialId($v)
    {
        ...
        if ($this->material_id !== $v) {
            $this->material_id = $v;
            $this->modifiedColumns[MaterialSupplierTableMap::COL_MATERIAL_ID] = true;
        }
    ...
    public function setSupplierId($v)
    {
        ...
        if ($this->supplier_id !== $v) {
            $this->supplier_id = $v;
            $this->modifiedColumns[MaterialSupplierTableMap::COL_SUPPLIER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MaterialSupplierTableMap::translateFieldName('MaterialId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->material_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MaterialSupplierTableMap::translateFieldName('SupplierId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = MaterialSupplierTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MocApi\\Models\\MaterialSupplier'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMaterialSupplierQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MaterialSupplier::setDeleted()
     * @see MaterialSupplier::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMaterialSupplierQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MaterialSupplierTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MaterialSupplierTableMap::COL_MATERIAL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'material_id';
        }
        if ($this->isColumnModified(MaterialSupplierTableMap::COL_SUPPLIER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'supplier_id';
        }

        $sql = sprintf(
            'INSERT INTO moc.material_supplier (%s) VALUES (%s)',
    ...
    {
        $pos = MaterialSupplierTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MaterialSupplier'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MaterialSupplier'][$this->hashCode()] = true;
        $keys = MaterialSupplierTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getMaterialId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MocApi\Models\MaterialSupplier
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MocApi\Models\MaterialSupplier The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MaterialSupplierTableMap::COL_MATERIAL_ID)) {
            $criteria->add(MaterialSupplierTableMap::COL_MATERIAL_ID, $this->material_id);
        }
        if ($this->isColumnModified(MaterialSupplierTableMap::COL_SUPPLIER_ID)) {
            $criteria->add(MaterialSupplierTableMap::COL_SUPPLIER_ID, $this->supplier_id);
        }
    ...
    {
        $criteria = ChildMaterialSupplierQuery::create();
        $criteria->add(MaterialSupplierTableMap::COL_MATERIAL_ID, $this->material_id);
        $criteria->add(MaterialSupplierTableMap::COL_SUPPLIER_ID, $this->supplier_id);
    ...
    {
        $validPk = null !== $this->getMaterialId() &&
            null !== $this->getSupplierId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation material_supplier_material_id_fkey to table moc.material
        ...
        //relation material_supplier_supplier_id_fkey to table moc.supplier
    ...
    {
        return (null === $this->getMaterialId()) && (null === $this->getSupplierId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MocApi\Models\MaterialSupplier (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MocApi\Models\MaterialSupplier Clone of current object.
     * @throws PropelException
     */
    ...
    public function getMaterial(ConnectionInterface $con = null)
    {
        if ($this->aMaterial === null && ($this->material_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMaterial->addMaterialSuppliers($this);
             */
        }
    ...
    public function getSupplier(ConnectionInterface $con = null)
    {
        if ($this->aSupplier === null && ($this->supplier_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSupplier->addMaterialSuppliers($this);
             */
        }
    ...
    {
        if (null !== $this->aMaterial) {
            $this->aMaterial->removeMaterialSupplier($this);
        }
        if (null !== $this->aSupplier) {
            $this->aSupplier->removeMaterialSupplier($this);
        }
    ...
    {
        return (string) $this->exportTo(MaterialSupplierTableMap::DEFAULT_STRING_FORMAT);
    }
