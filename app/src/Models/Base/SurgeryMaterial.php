...
/**
 * Base class that represents a row from the 'moc.surgery_material' table.
 *
 *
 *
* @package    propel.generator.MocApi.Models.Base
*/
abstract class SurgeryMaterial implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\MocApi\\Models\\Map\\SurgeryMaterialTableMap';
    ...
    /**
     * Initializes internal state of MocApi\Models\Base\SurgeryMaterial object.
     */
    ...
    /**
     * Compares this with another <code>SurgeryMaterial</code> instance.  If
     * <code>obj</code> is an instance of <code>SurgeryMaterial</code>, delegates to
     * <code>equals(SurgeryMaterial)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SurgeryMaterial The current object, for fluid interface
     */
     ...
     * @return $this|\MocApi\Models\SurgeryMaterial The current object (for fluent API support)
     */
    public function setSurgeryId($v)
    {
        ...
        if ($this->surgery_id !== $v) {
            $this->surgery_id = $v;
            $this->modifiedColumns[SurgeryMaterialTableMap::COL_SURGERY_ID] = true;
        }
    ...
    public function setMaterialId($v)
    {
        ...
        if ($this->material_id !== $v) {
            $this->material_id = $v;
            $this->modifiedColumns[SurgeryMaterialTableMap::COL_MATERIAL_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SurgeryMaterialTableMap::translateFieldName('SurgeryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->surgery_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SurgeryMaterialTableMap::translateFieldName('MaterialId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = SurgeryMaterialTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MocApi\\Models\\SurgeryMaterial'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSurgeryMaterialQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SurgeryMaterial::setDeleted()
     * @see SurgeryMaterial::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSurgeryMaterialQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SurgeryMaterialTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SurgeryMaterialTableMap::COL_SURGERY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'surgery_id';
        }
        if ($this->isColumnModified(SurgeryMaterialTableMap::COL_MATERIAL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'material_id';
        }

        $sql = sprintf(
            'INSERT INTO moc.surgery_material (%s) VALUES (%s)',
    ...
    {
        $pos = SurgeryMaterialTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SurgeryMaterial'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SurgeryMaterial'][$this->hashCode()] = true;
        $keys = SurgeryMaterialTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MocApi\Models\SurgeryMaterial
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MocApi\Models\SurgeryMaterial The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SurgeryMaterialTableMap::COL_SURGERY_ID)) {
            $criteria->add(SurgeryMaterialTableMap::COL_SURGERY_ID, $this->surgery_id);
        }
        if ($this->isColumnModified(SurgeryMaterialTableMap::COL_MATERIAL_ID)) {
            $criteria->add(SurgeryMaterialTableMap::COL_MATERIAL_ID, $this->material_id);
        }
    ...
    {
        $criteria = ChildSurgeryMaterialQuery::create();
        $criteria->add(SurgeryMaterialTableMap::COL_SURGERY_ID, $this->surgery_id);
        $criteria->add(SurgeryMaterialTableMap::COL_MATERIAL_ID, $this->material_id);
    ...
    public function hashCode()
    {
        ...
        //relation surgery_material_material_id_fkey to table moc.material
        if ($this->aMaterial && $hash = spl_object_hash($this->aMaterial)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }

        //relation surgery_material_surgery_id_fkey to table moc.surgery
    ...
    {
        return (null === $this->getSurgeryId()) && (null === $this->getMaterialId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MocApi\Models\SurgeryMaterial (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MocApi\Models\SurgeryMaterial Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aMaterial === null && ($this->material_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMaterial->addSurgeryMaterials($this);
             */
        }
    ...
    public function getSurgery(ConnectionInterface $con = null)
    {
        if ($this->aSurgery === null && ($this->surgery_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSurgery->addSurgeryMaterials($this);
             */
        }
    ...
    {
        if (null !== $this->aMaterial) {
            $this->aMaterial->removeSurgeryMaterial($this);
        }
        if (null !== $this->aSurgery) {
            $this->aSurgery->removeSurgeryMaterial($this);
        }
    ...
    {
        return (string) $this->exportTo(SurgeryMaterialTableMap::DEFAULT_STRING_FORMAT);
    }
