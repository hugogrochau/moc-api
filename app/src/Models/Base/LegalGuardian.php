...
/**
 * Base class that represents a row from the 'moc.legal_guardian' table.
 *
 *
 *
* @package    propel.generator.MocApi.Models.Base
*/
abstract class LegalGuardian implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\MocApi\\Models\\Map\\LegalGuardianTableMap';
    ...
    /**
     * Initializes internal state of MocApi\Models\Base\LegalGuardian object.
     */
    ...
    /**
     * Compares this with another <code>LegalGuardian</code> instance.  If
     * <code>obj</code> is an instance of <code>LegalGuardian</code>, delegates to
     * <code>equals(LegalGuardian)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|LegalGuardian The current object, for fluid interface
     */
     ...
     * @return $this|\MocApi\Models\LegalGuardian The current object (for fluent API support)
     */
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[LegalGuardianTableMap::COL_PERSON_ID] = true;
        }
    ...
    public function setRelationship($v)
    {
        ...
        if ($this->relationship !== $v) {
            $this->relationship = $v;
            $this->modifiedColumns[LegalGuardianTableMap::COL_RELATIONSHIP] = true;
        }
    ...
    public function setCPF($v)
    {
        ...
        if ($this->cpf !== $v) {
            $this->cpf = $v;
            $this->modifiedColumns[LegalGuardianTableMap::COL_CPF] = true;
        }
    ...
    public function setPatientId($v)
    {
        ...
        if ($this->patient_id !== $v) {
            $this->patient_id = $v;
            $this->modifiedColumns[LegalGuardianTableMap::COL_PATIENT_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LegalGuardianTableMap::translateFieldName('PersonId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->person_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LegalGuardianTableMap::translateFieldName('Relationship', TableMap::TYPE_PHPNAME, $indexType)];
            $this->relationship = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LegalGuardianTableMap::translateFieldName('CPF', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cpf = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : LegalGuardianTableMap::translateFieldName('PatientId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = LegalGuardianTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MocApi\\Models\\LegalGuardian'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLegalGuardianQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LegalGuardian::setDeleted()
     * @see LegalGuardian::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLegalGuardianQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LegalGuardianTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LegalGuardianTableMap::COL_PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = 'person_id';
        }
        if ($this->isColumnModified(LegalGuardianTableMap::COL_RELATIONSHIP)) {
            $modifiedColumns[':p' . $index++]  = 'relationship';
        }
        if ($this->isColumnModified(LegalGuardianTableMap::COL_CPF)) {
            $modifiedColumns[':p' . $index++]  = 'CPF';
        }
        if ($this->isColumnModified(LegalGuardianTableMap::COL_PATIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'patient_id';
        }

        $sql = sprintf(
            'INSERT INTO moc.legal_guardian (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'person_id':
                        ...
                        break;
                    case 'relationship':
                        $stmt->bindValue($identifier, $this->relationship, PDO::PARAM_STR);
                        break;
                    case 'CPF':
    ...
    {
        $pos = LegalGuardianTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['LegalGuardian'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LegalGuardian'][$this->hashCode()] = true;
        $keys = LegalGuardianTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getPersonId(),
            $keys[1] => $this->getRelationship(),
            $keys[2] => $this->getCPF(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MocApi\Models\LegalGuardian
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setRelationship($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MocApi\Models\LegalGuardian The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LegalGuardianTableMap::COL_PERSON_ID)) {
            $criteria->add(LegalGuardianTableMap::COL_PERSON_ID, $this->person_id);
        }
        if ($this->isColumnModified(LegalGuardianTableMap::COL_RELATIONSHIP)) {
            $criteria->add(LegalGuardianTableMap::COL_RELATIONSHIP, $this->relationship);
        }
        if ($this->isColumnModified(LegalGuardianTableMap::COL_CPF)) {
            $criteria->add(LegalGuardianTableMap::COL_CPF, $this->cpf);
        }
        if ($this->isColumnModified(LegalGuardianTableMap::COL_PATIENT_ID)) {
            $criteria->add(LegalGuardianTableMap::COL_PATIENT_ID, $this->patient_id);
        }
    ...
    {
        $criteria = ChildLegalGuardianQuery::create();
        $criteria->add(LegalGuardianTableMap::COL_PERSON_ID, $this->person_id);
    ...
    public function hashCode()
    {
        ...
        //relation legal_guardian_person_id_fkey to table moc.person
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MocApi\Models\LegalGuardian (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MocApi\Models\LegalGuardian Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPerson(ConnectionInterface $con = null)
    {
        if ($this->aPerson === null && ($this->person_id !== null)) {
            ...
            $this->aPerson->setLegalGuardian($this);
        }
    ...
    public function getPatient(ConnectionInterface $con = null)
    {
        if ($this->aPatient === null && ($this->patient_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPatient->addLegalGuardians($this);
             */
        }
    ...
    {
        if (null !== $this->aPerson) {
            $this->aPerson->removeLegalGuardian($this);
        }
        if (null !== $this->aPatient) {
            $this->aPatient->removeLegalGuardian($this);
        }
        $this->person_id = null;
    ...
    {
        return (string) $this->exportTo(LegalGuardianTableMap::DEFAULT_STRING_FORMAT);
    }
