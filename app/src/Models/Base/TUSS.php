...
/**
 * Base class that represents a row from the 'moc.TUSS' table.
 *
 *
 *
* @package    propel.generator.MocApi.Models.Base
*/
abstract class TUSS implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\MocApi\\Models\\Map\\TUSSTableMap';
    ...
    /**
     * Initializes internal state of MocApi\Models\Base\TUSS object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>TUSS</code> instance.  If
     * <code>obj</code> is an instance of <code>TUSS</code>, delegates to
     * <code>equals(TUSS)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TUSS The current object, for fluid interface
     */
     ...
     * @return $this|\MocApi\Models\TUSS The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TUSSTableMap::COL_ID] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[TUSSTableMap::COL_CODE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[TUSSTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[TUSSTableMap::COL_CREATED] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TUSSTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TUSSTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TUSSTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TUSSTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = TUSSTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MocApi\\Models\\TUSS'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTUSSQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTUSSQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TUSSTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('moc.TUSS_id_seq')");
        ...
        if ($this->isColumnModified(TUSSTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TUSSTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(TUSSTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(TUSSTableMap::COL_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'created';
        }

        $sql = sprintf(
            'INSERT INTO moc.TUSS (%s) VALUES (%s)',
    ...
    {
        $pos = TUSSTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TUSS'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TUSS'][$this->hashCode()] = true;
        $keys = TUSSTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MocApi\Models\TUSS
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MocApi\Models\TUSS The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TUSSTableMap::COL_ID)) {
            $criteria->add(TUSSTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TUSSTableMap::COL_CODE)) {
            $criteria->add(TUSSTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(TUSSTableMap::COL_DESCRIPTION)) {
            $criteria->add(TUSSTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(TUSSTableMap::COL_CREATED)) {
            $criteria->add(TUSSTableMap::COL_CREATED, $this->created);
        }
    ...
    {
        $criteria = ChildTUSSQuery::create();
        $criteria->add(TUSSTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MocApi\Models\TUSS (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MocApi\Models\TUSS Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTUSS is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTUSS The current object (for fluent API support)
     */
    public function setSurgeryTUsses(Collection $surgeryTUsses, ConnectionInterface $con = null)
    {
        ...
        foreach ($surgeryTUssesToDelete as $surgeryTUSSRemoved) {
            $surgeryTUSSRemoved->setTUSS(null);
        }
     ...
     * Otherwise if this TUSS is new, it will return
     * an empty collection; or if this TUSS has previously
     * been saved, it will retrieve related SurgeryTUsses from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TUSS.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildSurgeryTUSS[] List of ChildSurgeryTUSS objects
     */
    public function getSurgeryTUssesJoinSurgery(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSurgeryTUSSQuery::create(null, $criteria);
     ...
     * @return ChildTUSS The current object (for fluent API support)
     */
    ...
    protected function doAddSurgery(ChildSurgery $surgery)
    {
        ...
        $surgeryTUSS->setSurgery($surgery);
        ...
        if (!$surgery->isTUssesLoaded()) {
            $surgery->initTUsses();
            $surgery->getTUsses()->push($this);
        } elseif (!$surgery->getTUsses()->contains($this)) {
            $surgery->getTUsses()->push($this);
        }
    ...
    {
        if ($this->getSurgeries()->contains($surgery)) { $surgeryTUSS = new ChildSurgeryTUSS();

            $surgeryTUSS->setSurgery($surgery);
            if ($surgery->isTUssesLoaded()) {
                //remove the back reference if available
                $surgery->getTUsses()->removeObject($this);
            }
    ...
    {
        return (string) $this->exportTo(TUSSTableMap::DEFAULT_STRING_FORMAT);
    }
