...
use MocApi\Models\Material;
use MocApi\Models\MaterialQuery;
...
/**
 * This class defines the structure of the 'moc.material' table.
 *
 *
 *
...
class MaterialTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MocApi.Models.Map.MaterialTableMap';
     ...
     */
    const TABLE_NAME = 'moc.material';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\MocApi\\Models\\Material';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MocApi.Models.Material';
     ...
     */
    const COL_ID = 'moc.material.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'moc.material.name';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'moc.material.description';

    /**
     * the column name for the quantity field
     */
    const COL_QUANTITY = 'moc.material.quantity';

    /**
     * the column name for the created field
     */
    const COL_CREATED = 'moc.material.created';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(MaterialTableMap::COL_ID, MaterialTableMap::COL_NAME, MaterialTableMap::COL_DESCRIPTION, MaterialTableMap::COL_QUANTITY, MaterialTableMap::COL_CREATED, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(MaterialTableMap::COL_ID => 0, MaterialTableMap::COL_NAME => 1, MaterialTableMap::COL_DESCRIPTION => 2, MaterialTableMap::COL_QUANTITY => 3, MaterialTableMap::COL_CREATED => 4, ),
    ...
    {
        // attributes
        $this->setName('moc.material');
        $this->setPhpName('Material');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\MocApi\\Models\\Material');
        $this->setPackage('MocApi.Models');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('moc.material_id_seq');
        // columns
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('MaterialSupplier', '\\MocApi\\Models\\MaterialSupplier', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':material_id',
    1 => ':id',
  ),
), null, null, 'MaterialSuppliers', false);
        $this->addRelation('Surgery', '\\MocApi\\Models\\Surgery', RelationMap::MANY_TO_MANY, array(), null, null, 'Surgeries');
        $this->addRelation('Supplier', '\\MocApi\\Models\\Supplier', RelationMap::MANY_TO_MANY, array(), null, null, 'Suppliers');
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MaterialTableMap::COL_QUANTITY);
            $criteria->addSelectColumn(MaterialTableMap::COL_CREATED);
        } else {
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(MaterialTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(MaterialTableMap::TABLE_NAME)) {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MocApi\Models\Material) { // it's a model object
...
//
MaterialTableMap::buildTableMap();
