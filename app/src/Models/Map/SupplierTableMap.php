...
use MocApi\Models\Supplier;
use MocApi\Models\SupplierQuery;
...
/**
 * This class defines the structure of the 'moc.supplier' table.
 *
 *
 *
...
class SupplierTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MocApi.Models.Map.SupplierTableMap';
     ...
     */
    const TABLE_NAME = 'moc.supplier';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\MocApi\\Models\\Supplier';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MocApi.Models.Supplier';
     ...
     */
    const COL_ID = 'moc.supplier.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'moc.supplier.name';

    /**
     * the column name for the created field
     */
    const COL_CREATED = 'moc.supplier.created';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SupplierTableMap::COL_ID, SupplierTableMap::COL_NAME, SupplierTableMap::COL_CREATED, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SupplierTableMap::COL_ID => 0, SupplierTableMap::COL_NAME => 1, SupplierTableMap::COL_CREATED => 2, ),
    ...
    {
        // attributes
        $this->setName('moc.supplier');
        $this->setPhpName('Supplier');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\MocApi\\Models\\Supplier');
        $this->setPackage('MocApi.Models');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('moc.supplier_id_seq');
        // columns
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SupplierTableMap::COL_CREATED);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MocApi\Models\Supplier) { // it's a model object
